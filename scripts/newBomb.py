...
class NewBlast(Blast):
    def __init__(self, position=(0, 1, 0), velocity=(0, 0, 0), blastRadius=2.0,
        ...
        if self.blastType == 'ice':
            def _doEmit():
                try:
                    g = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g.delete)
                    g1 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g1.delete)
                    g2 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g2.delete)
                    g3 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g3.delete)
                    g4 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g4.delete)
                    g5 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g5.delete)
                    g6 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g6.delete)
                    g7 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g7.delete)
                    g8 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g8.delete)
                    g9 = bs.newNode('prop', delegate=self, attrs={'position':(position[0]-1+random.random()*3,position[1]+random.random()*2,position[2]-1+random.random()*3),'velocity':(0,0,0),'body':'sphere','shadowSize':0.3,'ice':True,'colorTexture':factory.impactTex,'bodyScale':1.5})
                    bs.gameTimer(6500,g9.delete)
                    bs.emitBGDynamics(position=(position[0]-1+random.random()*2,position[1]+random.random(),position[2]-1+random.random()*2),velocity=(0,0,0),count=5,scale=7.5,chunkType='ice',emitType='stickers');
                    bs.emitBGDynamics(position=(position[0]-1+random.random()*2,position[1]+random.random(),position[2]-1+random.random()*2),velocity=(0,0,0),count=5,scale=7.5,chunkType='ice',emitType='stickers');
                    bs.emitBGDynamics(position=(position[0]-1+random.random()*2,position[1]+random.random(),position[2]-1+random.random()*2),velocity=(0,0,0),count=5,scale=7.5,chunkType='ice',emitType='stickers');
                    bs.emitBGDynamics(position=(position[0]-1+random.random()*2,position[1]+random.random(),position[2]-1+random.random()*2),velocity=(0,0,0),count=5,scale=7.5,chunkType='ice',emitType='stickers');
                    bs.emitBGDynamics(position=(position[0]-1+random.random()*2,position[1]+random.random(),position[2]-1+random.random()*2),velocity=(0,0,0),count=5,scale=7.5,chunkType='ice',emitType='stickers');
