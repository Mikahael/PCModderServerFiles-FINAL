...
class HockeyStadium(Map):
    ...
    def onPreload(cls):
        ...
        data['standsTex'] = bs.getTexture('black')
    ...
    def __init__(self):
        ...
        if fire.nighty:
         bsGlobals.tint = (1.32,1.32,1.32)
        else:
         bsGlobals.tint = (0.5,0.7,1)

        bsGlobals.ambientColor = (1,1,1)
        bsGlobals.vignetteOuter = (1.32,1.32,1.32)
        bsGlobals.vignetteInner = (1.93,1.93,1.95)
...
class FootballStadium(Map):
    ...
    playTypes = ['melee','hockey','teamFlag','keepAway','football']
...
class BridgitMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture("black")
...
class RampageMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('black')
        data['bgTex2'] = bs.getTexture('black')
